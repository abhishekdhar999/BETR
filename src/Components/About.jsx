...
export default function About() {
  ...
  return (
    <div ref={aboutRef} className='h-screen flex flex-col justify-center items-center py-20 px-0 mb-12'>
      <div className='group'>
        <div className='heading flex justify-center text-center items-center mb-14'>
          <h1 className='heading tag text-4xl font-futura font-thin'>ABOUT</h1>
        </div>
      ...
      <div className='detail flex justify-center items-center text-lg my-12 h-auto'>
