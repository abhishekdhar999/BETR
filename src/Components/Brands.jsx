      ...
      <div className='flex justify-center items-center h-full md:flex-row flex-col'>
        <div className='left mx-24'>
          ...
          <div className='heading'>
            <p className='outlets text-8xl text-auto font-futura' style={{ fontWeight: 100 }}>12+ OUTLETS</p>
          </div>
          <div className='bg-[#f2ea3e] h-1 mx-0'></div>
          <div className='sub-heading mx-2 my-2'>
            <p className='texts1 text-4xl text-gray-500 font-futura' style={{ fontWeight: 100 }}>LAUNCHING MINDFUL</p>
            <p className='texts2 text-4xl text-gray-500 font-futura' style={{ fontWeight: 100 }}>FOOD BRANDS</p>
            <p className='texts3 text-4xl text-gray-500 font-futura' style={{ fontWeight: 100 }}>ACROSS DELHI NCR</p>
          </div>
          <div className='bg-orange-600 h-1 w-36 mx-2'></div>
        </div>
        
        <div className='right md:my-0 my-8'>
          <img className='sm:h-[600px] sm:w-[700px] h-[300px] w-[400px]' src={img} alt="Brands" />
        </div>
      </div>
    </div>
  );
