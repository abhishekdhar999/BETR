...
export default function Founders() {
  return (
    <div id='founders' className='all my-24 bg-[#fcfef6]'>
      ...
      <div className='founders flex flex-col md:flex-row mx-4 md:mx-12 mt-20'>
        {/* Founder 1 */}
        <div className='founder mx-4 my-4 md:w-1/3'>
          {/* Founder Image */}
          <div className='img mb-4'>
            <div className='bg-[#d2e5b6] h-16 w-16 rounded-full mx-auto md:mx-0'></div>
          </div>
          {/* Founder Name */}
          <div className='name my-2'>
            <h1 className='font-futura text-lg font-bold text-center md:text-left'>MR CHETAN PRADHAN</h1>
          </div>
          {/* Underline */}
          ...
          <div className='intro'>
            ...
            <p className='text-[16px] text-justify font-futura mt-4'>
        ...
        <div className='founder mx-4 my-4 md:w-1/3'>
          ...
          {/* Founder Name */}
          <div className='name my-2'>
            <h1 className='font-futura text-lg font-bold text-center md:text-left'>DR REKHA</h1>
          </div>
          {/* Underline */}
          <div className='underline bg-black h-[0.7px] w-full my-4'></div>
          {/* Founder Intro */}
        ...
        <div className='founder mx-4 my-4 md:w-1/3'>
          ...
          {/* Founder Name */}
          <div className='name my-2'>
            <h1 className='font-futura text-lg font-bold text-center md:text-left'>MR ARJUN</h1>
          </div>
          {/* Underline */}
          <div className='underline bg-black h-[0.7px] w-full my-4'></div>
          {/* Founder Intro */}
