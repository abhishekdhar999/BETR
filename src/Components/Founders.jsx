...
export default function Founders() {
  return (
    <div className='all my-24 bg-[#fcfef6]'>
      ...
      <div className="sub-heading flex justify-center items-center  mx-auto  text-center text-[13px] my-6 max-w-[700px]">
  <p className='font-futura'>
    Betr India Foodworks is spearheaded by a dynamic trio of co-founders, whose blend of expertise & collective vision fuels the company's trajectory toward success. With a solid foundation laid by the leadership, the company boasts a robust team structure comprising 5 seasoned advisors and a dedicated core team of 15 individuals.
      ...
      <div className='founders flex md:flex-row flex-col  mx-12 mt-20'>
        <div className='one mx-4 my-4'>
        ...
        <div className='intro'>
            <p className='text-[10px] text-justify font-futura'>Introducing Chetan Pradhan, a 28-year-old innovator and entrepreneur, Founder of BETR India Foodworks. Chetan's journey is characterized by a diverse skill set and a forward-thinking approach.
After completing his Master's in Business Commerce, Chetan delved into the intricacies of founding a real estate development firm, gaining valuable insights from 2015 to 2018. In 2018, he pivoted remarkably, opening a health food restaurant that reflected his commitment to wellness and culinary innovation. Chetan's expertise extends beyond the surface, encompassing the core operations of the F&B business. This hands-on experience distinguishes him as a leader with a deep understanding of the industry-from culinary intricacies to operational efficiency. His strategic vision, honed by both academic and practical knowledge, promises a unique blend of innovation and operational excellence.</p>
        </div>
        </div>
        
        <div className='two mx-4 my-4'>
        <div className='img mb-4'>
            <div className='bg-[#d2e5b6] h-16 w-16 rounded-full'></div>
        </div>
        <div className='name my-2'>
            <h1 className='font-futura'>DR REKHA</h1>
        </div>
        <div className='underline bg-black h-[0.7px] w-auto my-4'></div>
        <div className='intro'>
            <p className='text-[10px] text-justify font-futura '>
        Meet Dr. Rekha, a trailblazing founder of Betr India Foodworks and a distinguished healthcare professional. Currently serving as an Assistant Professor in one of Delhi's most prestigious hospitals, Dr. Rekha boasts over 15 years of invaluable experience as a seasoned doctor. br
...
In addition to her medical expertise, Dr. Rekha is a powerhouse of knowledge in nutrition, people management, and training. This multifaceted skill set positions her as a key architect in the foundation of Betr India Foodworks. Her name stands synonymous with a commitment to excellence and well-being, making Betr India Foodworks a formidable player in the F&B industry under her visionary leadership.
        ...
        <div className='three mx-4 my-4'>
        <div className='img mb-4'>
            <div className='bg-[#d2e5b6] h-16 w-16 rounded-full'></div>
        </div>
        <div className='name'>
            <h1 className='font-futura'>MR ARJUN</h1>
        </div>
        <div className='underline bg-black h-[0.7px] w-auto my-4'></div>
        <div className='intro'>
            <p className='text-[10px] text-justify font-futura'>Meet Mr. Arjun, an instrumental founder of Betr India Foodworks and a seasoned professional with over 15 years of expertise in the media industry.
...
As a key figure in Betr India Foodworks, Arjun's multifaceted experience in the media industry uniquely positions the startup for success. His name is synonymous with effective team leadership and strategic execution, making BETR India Foodworks a dynamic and promising venture under his guidance.</p>
        </div>
        </div>
      </div>
    </div>
