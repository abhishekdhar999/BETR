...
export default function LandingPage() {
  ...
  <div >
  <h1 className="text-4xl mx-2 flex font-futura">ON A MISSION TO MAKE <div className="text-6xl font-caveat  mx-8 w-[150px] ">{dynamicNames[currentNameIndex]}</div> <div className="font-extrabold text-4xl font-futura">BETR.</div></h1>
